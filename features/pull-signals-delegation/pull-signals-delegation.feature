...
#     Given l'utente ha già una delega in stato "ACTIVE" concessa dal "Comune di Copparo" per l'e-service "domicili digitali"
#     Given l'utente ha già una richiesta di fruizione in stato "ACTIVE" per conto dell'ente delegante per quell' e-service
#     Given l'utente ha già una finalità in delega in stato "ACTIVE" per quell'e-service
#     Given l'utente ha già una delega in stato "ACTIVE" concessa dal "Comune di Castelfranco"
#     Given l'utente ha già una richiesta di fruizione in stato "ACTIVE" per conto dell'ente delegante per quell' e-service
#     Given l'utente ha già una finalità in delega in stato "ACTIVE" per quell'e-service
#     When l'utente recupera un segnale di quell'e-service
#     Then la richiesta va a buon fine con status code 200 e restituisce una lista di 1 segnale
...
#     Given l'utente ha già una delega in stato "ACTIVE" concessa dal "Comune di Copparo"
#     Given l'utente ha già una richiesta di fruizione in stato "ACTIVE" per conto dell'ente delegante per quell' e-service
#     Given l'utente ha già una finalità in delega in stato "ACTIVE" per quell'e-service
